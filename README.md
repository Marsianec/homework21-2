# Домашнее задание к занятию «Средство визуализации Grafana» - Тертерян Вячеслав
...
![alt text](https://github.com/Marsianec/homework21-2/blob/main/img/1.png)  
...
![alt text](https://github.com/Marsianec/homework21-2/blob/main/img/2.png)  
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "node_cpu_seconds_total - (irate(node_cpu_seconds_total{instance=\"node-exporter:9100\", mode=\"idle\"}[5m]))",
