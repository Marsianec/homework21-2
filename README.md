...
```100 - ((irate(node_cpu_seconds_total{instance="node-exporter:9100",mode="idle"}[5m])) * 100)```
- CPULA 1/5/15  
```100 - (avg by (instance)(irate(node_cpu_seconds_total{instance="node-exporter:9100",mode="idle"}[5m])) * 100)```
